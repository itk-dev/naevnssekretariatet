...
class SidebarController extends AbstractController
{
    ...
    public function renderCaseSubmenu(UuidV4 $caseId, string $activeRoute): Response
    {
        ...
        if ($isCaseworker || $isAdministration) {
            $submenuItems[] = $this->generateSubmenuItem($this->translator->trans('Hearing', [], 'sidebar'), ['case_hearing', 'case_hearing_index', 'case_hearing_start', 'case_hearing_post_create', 'case_hearing_post_show', 'case_hearing_post_edit', 'case_hearing_post_document_upload'], $caseId, $activeRoute);
