...
//            $submenuItems[] = $this->generateSubmenuItem($this->translator->trans('Communication', [], 'sidebar'), ['digital_post_index', 'digital_post_show'], $caseId, $activeRoute);
            $submenuItems[] = $this->generateSubmenuItem($this->translator->trans('Case event', [], 'sidebar'), ['case_event_index', 'case_event_show', 'case_event_create', 'case_event_edit', 'digital_post_show'], $caseId, $activeRoute);
