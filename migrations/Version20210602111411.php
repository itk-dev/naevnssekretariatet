 ...
 */
final class Version20210602111411 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE document_case_entity (document_id INT NOT NULL, case_entity_id BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid)\', INDEX IDX_256F34ABC33F7837 (document_id), INDEX IDX_256F34ABAF060DA6 (case_entity_id), PRIMARY KEY(document_id, case_entity_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
