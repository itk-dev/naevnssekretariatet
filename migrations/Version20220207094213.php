...
final class Version20220207094213 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE document_digital_post (id BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid)\', recipient_cpr VARCHAR(10) NOT NULL, recipient_name VARCHAR(255) NOT NULL, status VARCHAR(32) DEFAULT NULL, sent_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', data LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:json)\', recipient_address_street VARCHAR(255) NOT NULL, recipient_address_number VARCHAR(255) NOT NULL, recipient_address_floor VARCHAR(255) DEFAULT NULL, recipient_address_side VARCHAR(255) DEFAULT NULL, recipient_address_postal_code INT NOT NULL, recipient_address_city VARCHAR(255) NOT NULL, recipient_address_validated_at DATETIME DEFAULT NULL, recipient_address_bbr_data LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:json)\', PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
