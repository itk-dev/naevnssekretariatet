 ...
 */
final class Version20220211140633 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE hearing (id BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid)\', complainant_has_no_more_to_add TINYINT(1) DEFAULT \'0\' NOT NULL, counterpart_has_no_more_to_add TINYINT(1) DEFAULT \'0\' NOT NULL, has_new_hearing_post TINYINT(1) DEFAULT \'0\' NOT NULL, started_on DATE DEFAULT NULL, finished_on DATE DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE hearing_post (id BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid)\', hearing_id BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid)\', recipient_id BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid)\', template_id BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid)\', content LONGTEXT NOT NULL, forwarded_on DATE DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, INDEX IDX_54293ABF66F0CD18 (hearing_id), INDEX IDX_54293ABFE92F8F78 (recipient_id), INDEX IDX_54293ABF5DA0FB8 (template_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
